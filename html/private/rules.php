      ...
      <div class="maintable">
        <dl class="lists">
          ...
          <div class="sub">
            ...
            <p>各クラス２人　計24名</p>
            <dd>点数</dd>
            <p>各レース　1位:30pt　2位:20pt　3位:15　4位:10pt</p>
            <dd>説明</dd>
            ...
            <p>【規 則】
              <br>☆400m
              走(本部前スタート→本部前ゴール)。<br>☆高校1年、2年、3年の順で学年別に3レース行う。<br>☆各学年、2人×4組=8人が一緒に走る。<br>■胴体がゴールラインを越えた時にゴールとする。<br>◇各学年上位2名、それ以外のタイム上位者2名の計8名が決勝
              進出。<br>【罰 則】<br>●フライングがあったときは、スタートをやり直す。<br>▶他の競技者を妨害したり、トラックの線を踏み越えたときは、 当該競技者を失格させ得る。<br>
              【主 審】<br>1名
              指揮台に位置し、競技に関する事項(スタート、ゴールなど)について判断する。時間計測について担当者を指揮監督する。<br>△スタート位置を公平な方法で決定する。<br>●スタートの合図をする。<br>▶他者を妨害したり、トラックの線を踏み越えていないか監視する。<br>▶ゴールテープの準備を指揮する。<br>■1位及び最下位がゴールしたときに合図する。
            </p>
          </div>
          ...
          <div class="sub">
            ...
            <dd class="judge">審判規則</dd>
            <p>【規則】<br>
              ☆1対1トーナメント方式<br>☆各組は13基の騎馬を組む。<br>☆騎馬は騎手のハチマキ、もしくは帽子が相手にとられたときに騎馬は無力化され、競技者は騎馬を崩し、場外に戻る。<br>▶1 分経過時点、2
              分経過時点でそれぞれ、戦闘領域が狭まる。
              <br>▶騎馬を最前で支える者は相手の騎馬の最前の者と正面から接触してはならない。<br>▶競技者は相手の騎馬を故意に崩すなどのけがにつながりかねない行為をしてはならない。<br>■スタートから 3
              分経過する、もしくは大将騎馬が無力化された時点で終了する。
              <br>◇大将騎馬のハチマキが取られた時点で取られたチームの負け。<br>◇3 分経過時に大将騎馬が両組生存している場合、生存している騎馬の数が多い方の勝ち。<br>◇3
              分経過時に大将騎馬が両組生存しており、生存している騎馬の数も同数だった場合、サドンデスとなり、先に相手の騎馬を 1 騎でも無力化した方の勝ち<br>
              【罰則】<br>●スタート前に走り出す騎馬があった場合にはスタートをやり直す。<br>▶相手の騎馬を故意に崩すなど、けがにつながりかねない危険行為をしたときは、当該騎馬を無力化するが、崩された騎馬が再び有効化することはできない。<br>
              【主審】<br>1名
              指揮台に位置し、競技を常に監視し、競技の開始、終了、得点、勝敗その他一切の競技に関する事項について判断する。<br>●用意、スタートの合図をする。<br>▶重大な危険行為があった際には直ちに競技の中断を合図する。<br>
              ■大将騎馬の無力化又は、3 分経過時に終了の合図をし、勝敗を判断する。<br>
              【副審】<br>13名 南側チームのそれぞれの騎馬に付き、競技を常に監視する。<br> ▶騎馬の帽子、ハチマキが取られた際に、速やかに当該騎馬に騎馬を崩すことを促す。
              <br>▶危険行為があった際にその行為をやめるように指導する。 <br>▶大将騎馬が無力化された場合には直ちに主審に伝える。<br>
              ■主審の終了の合図に合わせて未だ生存している騎馬に騎馬を崩すことを促す。<br>
              【副審】<br>戦場内に自由に位置し、競技を常に監視する。 <br>▶騎馬の帽子、ハチマキが取られた際に、速やかに当該騎馬に騎馬を崩すことを促す。
              <br>▶危険行為があった際にその行為をやめるように指導する。<br> ▶大将騎馬が無力化された場合には直ちに主審に伝える。<br> ■主審の終了の合図に合わせて未だ生存している騎馬に騎馬を崩すことを促す。
            </p>
          </div>
