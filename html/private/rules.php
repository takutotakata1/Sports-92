...
<body class="animsition">
  ...
  <nav class="gnav">
    <div class="gnav__wrap">
      <ul class="gnav__menu">
        <li class="gnav__menu__item toppages"><a href="toppage.html"
            class="animsition-link">トップページ<br><span>Top</span></a></li>
        <li class="gnav__menu__item programs"><a href="program.html"
            class="animsition-link">プログラム<br><span>Program</span></a></li>
        <li class="gnav__menu__item ruless"><a href="rules.html" class="animsition-link">競技説明<br><span>Rules</span></a>
        </li>
        <li class="gnav__menu__item pointss"><a href="points.html"
            class="animsition-link">現在の得点<br><span>Points</span></a></li>
        <li class="gnav__menu__item articless"><a href="articles.html"
            class="animsition-link">記事一覧<br><span>Articles</span></a></li>
      </ul>
    </div>
  </nav>
  <div class="main">
    ...
    <div class="maincontent">
      <h1 class="midashi"><span>競</span>技説明</h1>
      <div class="maintable">
        <dl class="lists">
          <dt>理事長杯予選</dt>
          <div class="sub">
          ...
          <div class="sub">
            ...
            <dd>審判規則</dd>
            <p>【規 則】
              <br>☆1対1トーナメント方式。<br>☆各組は各棒に自由に競技者を配置する。<br>☆棒の配点は、中央の棒が50点、その両脇の棒が40点、他の 4本の棒が30点とする。<br>△スタート前に競技者は陣内の自由な位置に立つ。<br>▶競技者は、他の棒に自由に移動して良い。<br>▶競技者は、棒の中央より敵陣側の部分に触れてはならない。<br>▶棒にぶら下がってひきづられるなど怪我につながりかねない行為をしては行けない。<br>
              ...
              【罰 則】<br>●スタート前に走り出す者がいたときは、スタートをやり直す。 <br>▶棒の中央より敵陣側の部分に触れる、相手の競技者に触れる、 棒で相手競技者の体を打つ、棒を曲げようとする、棒を押す、棒 を立てるなどして水平でなくする、棒を振り回す、棒を南北方向 以外の方向に向ける、棒を限界線の外に出すなどしたときは、当該競技者を退場、又は当該組の当該棒の取得を無効などとする。<br>●競技参加者が過剰であった場合担当者が出場者を自由に減らす権限を持つ。<br>
              ...
              【副 審】<br>7名 (棒の運搬→審判) 担当の棒の周辺に位置し、当該棒及び戦いを常に監視する。棒の中心が陣内まで引かれたかどうか判断し、得点を認める場合は競技終了後に棒を立てる。<br>▶棒の中央より敵陣側の部分に触れたり、相手の競技者に触れたり、棒で相手競技者の体を打ったり、突いたり、棒を曲げようとしたり、棒を押したり、棒を立てるなどして水平でなくしたり、 棒を振り回したり、棒を南北方向以外の方向に引いたり、棒を限界線の外に出していないか監視し、当該反則行為があったときは 規則を守るよう指導する。<br>
          ...
          <div class="sub">
            ...
            <dd>審判規則</dd>
            <p>【規 則】<br>
              ☆1対1トーナメント方式。<br>☆各組は各棒に均等に競技者を配置する。 (ただし、人数が割り切れない場合は若いグループから1人ずつ振り分ける)<br>●競技者は棒についてする。ただしスタート前に棒に触れてはならない。<br>▶競技者は、自分の棒の引き合いが決着したときを含め、他の棒に移動してはならない。<br>▶競技者は、棒の中央より敵陣側の部分に触れたり、相手の競技者に触れてはならない。<br>
              ■棒の中央が目標線を越えたときに、棒を引き込んだと認める。<br>◇棒を多く取った方の勝ち。<br>
              【罰 則】<br>●スタート前に棒に触れたときは、スタートをやり直す。<br>▶他の棒に移動したり、棒の中央より敵陣側の部分に触れたり、相手の競技者に触れたときは、当該競技者を退場させ、又は当該組の当該棒の取得を無効とし、若しくは当該棒を相手組が取得したものなどとみなしうる。<br>
              【主 審】<br>1名 指揮台に位置し、競技を常に監視し、競技の開始、終了、勝敗について判断する。<br>●用意、スタートの合図をする。<br>■各棒の戦いが全て終了した時に合図する。<br>◇勝敗を決定する。<br>
              【副 審】<br>7名 (運搬→審判)棒の中央が陣内まで引かれたことは副審が判断し、直ちに棒を立てる。<br>●スタート前に棒に触れた者がいないか監視する。<br>▶他の棒に移動したり、棒の中央より敵陣側の部分に触れたり、相手の競技者に触れていないか監視し、当該反則行為があったと きは、規則を守るよう指導する。<br>■棒の中央が目標線を越えた時、競技者に戦いの終了を告げ、目標線上で棒を立てて主審に伝える。
          ...
          <div class="sub">
            ...
            <dd>審判規則</dd>
            <p>【規則】<br>
              ☆往復リレー(南側スタート→南側ゴール) <br>☆競技者は南側をスタートし、北側に位置するコーンを回ってスタート位置まで戻る。<br>☆各競技者の足は隣の競技者とはちまきで繋がれている<br>☆2人チーム6組、3人チーム2組の計8組18人のチームを作っておく。
              <br>●スタート前に走り出してはならない<br>▶2人のチームが6組走り終わると次は3人の2組が走る。それが終わると、2人のチームのうち4チームが合体して4人のチーム2組となり、走る。その次は残りの組が合体して5人のチーム2 組となって走る。<br>□最後の走者がゴールライン(スタートライン)に戻ってきた時点でゴールとする。<br>
              ...
              【副審】<br>4名 (運搬→審判) 自由に位置を取り、主に各クラスの旋回を監視し、フライング、不正が行われていないか監視する。 <br>△競技場内に支障がないことを確認する。 ●競技者がスタート前に走り出していないか監視、もし走り出していた場合は大きく手を挙げ主審に伝える。<br>▶その他他者を妨害したり、不正をしていないか監視する。 <br>▶競技者に、次走る時のために予め準備をしておくことを伝える。              
              </p>
          </div>
          ...
          <div class="sub">
            ...
            <p>1位:200pt　2位:150pt　3位:120pt　4位:100pt</p>
            <dd>説明</dd>
            <p>run for pullは1クラスが2組に分かれて行う綱引きです。40 人が"pull"側として綱のそばに、残りの人は"run"側として相手側からスタートします。"run"側はぐるっ と綱を走って回って"pull"側に合流する形をとります。<br>＊ESSの部員から「run to pull」ではないかというご指摘を受けました。</p>
            <dd>審判規則</dd>
            <p>【規則】<br>
              ☆1対1トーナメント方式<br>☆チーム内で run 側と pull 側に分かれ、pull 側は予め本部前の 綱の横におり、スタートの合図と同時に綱を引く。run 側は生徒 テント側におり、スタートの合図とともに綱へ走り、pull 側に加わる。<br>●pull 側はスタート前に綱に触れてはならない<br>
              ●run 側はスタート前にラインを超えてはならない <br>■旗が完全に倒れて始めて勝敗が決する<br>◇綱に括りつけられた旗の倒れた側を勝者とする<br>▶競技者は、綱の中央より敵陣側の部分に触れてはならない <br>▶綱にぶら下がる、綱の上に乗るなど、競技の進行に影響を及ぼしかねない行為を行ってはならない<br>
              【罰則】<br>●スタート前に縄に触れる、あるいはスタート前に走り出す者が いたときは、スタートをやり直す <br>▶上記のような、競技の進行に影響を及ぼす又は怪我につながる 危険な行為が発見された場合は、スタートのやり直し、又は当該者を退場させる<br>
              【主審】<br>1名 縄の中央に繋がれた旗の周辺に位置し、競技を常に監視し、競技の開始、終了、勝敗その他一切の競技に関する事項について判断する。競技の勝敗に係る判断を旗によって示す。<br>●位置について、用意、スタートの合図をする。<br>●スタート前に縄に触れる、または走り出す者がいないか監視する。<br>
              △綱を整える。<br>△手旗紅白1組を持つ。<br>■綱が片方に引かれたことによって、綱の中央に繋がれた旗が倒れた時に勝敗を判断し、勝った方の手旗を高く挙げる。<br>
              【副審】<br>2名(コーンの運搬→審判) 生徒テント側スタートライン横に位置し、run 側のスタートを監視する。<br>●run 側の生徒がスタート前に走り出していないか監視する。当該行為があった場合は大きく手を挙げて主審に伝え、スタートをやり直す。
              </p>
          </div>
          ...
          <div class="sub">
            ...
            <p>9.THE CHIKARA―ワンゲラー<br>
              【規 則】<br>
              ☆100m×10 人リレー(本部前スタート→本部前ゴール)。<br>☆水入り 2L ペットボトルを各走者が持って走る。1・2:2 個、 3・4:4 個、5・6:6 個、7・8:8 個、9・10:10 個。 ▶ペットボトルはリュックに入れる外、手に持つなどしてもよい。<br>
              【罰 則】<br>●フライングがあったときは、スタートをやり直す。<br>▶他の競技者を妨害したり、トラックの線を踏み越えたり、テイクオーバーゾーンを越えたときは、当該組を最下位とし、又は失格させ得る。<br>▶リュックやペットボトルを落としたときは、自ら拾う。トラックの内側に落としたときは、拾った後、落とした地点から再開する。<br>
              ...
              【副 審】<br>1 名 本部反対側テイクオーバーゾーン周辺に位置し、競技を常に監視する。<br>▶他者を妨害したり、トラックの線を踏み越えていないか監視する。<br>▶コーナーでの順位に基づいて本部反対側次走者のスタート順を決定し、その通りに並ばせる。<br>
              ...
              ☆1 人目はスタート→〔手押し車〕→腕立て伏せ 20 回→〔走る〕→〔うさぎ跳び〕→〔タイヤを持って走る〕→〔麻袋に入って跳んで前進〕→バトンタッチ、2 人目はバトンタッチ→〔手押し車〕→腕立て伏せ 20 回→〔走る〕→腹筋運動(上体起こし)20 回→〔走る〕→スクワット 20 回→〔走る〕→背筋運動 20 回→〔走 る〕→ゴールの順に進む。<br>
              ▶バトンタッチは、1 人目がスタートラインまで進んだ時に 2 人目がスタートラインから進み始めることとする(バトンはない)。<br> ▶腹筋では審判員が足首を固定する。<br>▶背筋でもうつ伏せになってもらい審判員が足首を固定する。<br>
              【罰 則】<br>●フライングがあったときは、スタートをやり直す。<br>▶他の競技者を妨害したり、トラックの線を踏み越えたり、障害を越えるために不正をしたときは、当該組を最下位とし、又は失格させ得る。<br>▶タイヤを落としたときは、自ら拾う。トラックの内側に落としたときは、拾った後、落とした地点から再開する。<br>
              【主 審】<br>1 名 指揮台に位置し、競技を常に監視し、スタート、走り、ゴールそ の他一切の競技に関する事項について判断する。<br>△競技場内に支障がないこと、競技場のマークや用具が所定の位置にあることを確認する。<br>△スタート位置を公平な方法で決定する。<br>●位置について、用意、スタートの合図をする。<br>
              ▶他者を妨害したり、トラックの線を踏み越えたり、障害に不公平が生じたり、障害を越えるために不正をしてないか監視する。 <br>▶ゴールテープの準備を指揮する。<br>■1 位及び最下位がゴールしたときに合図する。 <br>◇順位を決定する。<br>
              【補助審】<br>4 名(タイヤ大運搬→審判) 各競技者に付き添い、競技を常に監視及び指導して、主審を助ける。<br>△競技場内に支障がないことを確認する。<br>●スタート時は、位置についての合図で各競技者をしてスタートラインの手前に両手をつかせ、用意の合図で競技者の足を持ち上げる。<br>
              ▶手押し車は、競技者が腕力で進むものであるから、競技者を後ろから押したり引いたりしてはならない。また、競技者の足を持ち上げる高さは概ね腰の高さとし、他の補助審と異ならないように注意する。<br>▶腕立て伏せ、腹筋、スクワット、背筋はその回数を数え、「1、 2、......」と競技者に言い聞かせる。また、その形が他の競技者と異ならないように注意する。<br>
              ▶うさぎ跳び、タイヤ運び、麻袋ジャンプはそれぞれ開始と終了のタイミングで競技者に指示し、監視する。<br>▶1 人目が麻袋ジャンプをしている間にスタートラインまで速やか に移動し、2 人目の手押し車の準備をする。<br>▶1 人目の体の一部が麻袋ジャンプでスタートラインを越えた時 に、2 人目に声をかけて指示し、手押し車を始める。
              </p>
          </div>
          ...
          <div class="sub">
            ...
            <p>【規 則】<br>
              ...
              ▶棒の中央より敵陣側の部分に触れる、相手の競技者に触れる、棒で相手競技者の体を打つ、棒を曲げようとする、棒を押す、棒を立てるなどして水平でなくする、棒を振り回す、棒を南北方向 以外の方向に向ける、棒を限界線の外に出すなどしたときは、当該競技者を退場、又は当該組の当該棒の取得を無効などとする。<br>
